...
import './MiraculousBoxReplica.css';
...
interface MiraculousBoxReplicaProps {
...
const MiraculousBoxReplica: React.FC<MiraculousBoxReplicaProps> = ({
  characters,
  onKwamiClick,
  selectedCharacter
}) => {
    ...
    return (
      <div className="replica-character-view">
        <div className="replica-box-section">
          <div className="replica-box-container">
          <div className="miraculous-box-replica">
            {/* Center Circle - Both Ladybug and Cat Noir */}
            <div className="center-circle">
              <div className="miraculous-jewel center-jewel-ladybug" onClick={() => handleMiraculousClick('ladybug')}>
                <img src={getMiraculousImage('ladybug')} alt="Ladybug Miraculous" />
              </div>
              <div className="miraculous-jewel center-jewel-cat" onClick={() => handleMiraculousClick('cat')}>
                <img src={getMiraculousImage('cat')} alt="Cat Miraculous" />
              </div>
            </div>

            {/* Inner Hexagonal Ring - Only 5 miraculous */}
            <div className="inner-hexagon">
              <div className="miraculous-jewel inner-jewel inner-top" onClick={() => handleMiraculousClick('fox')}>
                <img src={getMiraculousImage('fox')} alt="Fox Miraculous" />
              </div>
              <div className="miraculous-jewel inner-jewel inner-top-right" onClick={() => handleMiraculousClick('bee')}>
                <img src={getMiraculousImage('bee')} alt="Bee Miraculous" />
              </div>
              <div className="miraculous-jewel inner-jewel inner-bottom-right" onClick={() => handleMiraculousClick('peacock')}>
                <img src={getMiraculousImage('peacock')} alt="Peacock Miraculous" />
              </div>
              <div className="miraculous-jewel inner-jewel inner-bottom" onClick={() => handleMiraculousClick('butterfly')}>
                <img src={getMiraculousImage('butterfly')} alt="Butterfly Miraculous" />
              </div>
              <div className="miraculous-jewel inner-jewel inner-left" onClick={() => handleMiraculousClick('turtle')}>
                <img src={getMiraculousImage('turtle')} alt="Turtle Miraculous" />
              </div>
            </div>

            {/* Outer Ring Compartments - 12 remaining miraculous */}
...
export default MiraculousBoxReplica;
